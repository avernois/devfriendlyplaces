...
var _user$project$Devfriendly$townsUrl = 'http://localhost:8000/locations/locations.json';
var _user$project$Devfriendly$baseUrl = 'http://localhost:8000/locations/';
var _user$project$Devfriendly$placesUrlFor = function (town) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_user$project$Devfriendly$baseUrl,
		A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$String$toLower(town),
			'.json'));
};
var _user$project$Devfriendly$moveMap = _elm_lang$core$Native_Platform.outgoingPort(
	'moveMap',
	function (v) {
		return {name: v.name, latitude: v.latitude, longitude: v.longitude, defaultZoom: v.defaultZoom};
	});
var _user$project$Devfriendly$addPlaces = _elm_lang$core$Native_Platform.outgoingPort(
	'addPlaces',
	function (v) {
		return _elm_lang$core$Native_List.toArray(v).map(
			function (v) {
				return {name: v.name, latitude: v.latitude, longitude: v.longitude};
			});
	});
var _user$project$Devfriendly$Model = F2(
	function (a, b) {
		return {towns: a, places: b};
	});
var _user$project$Devfriendly$Town = F4(
	function (a, b, c, d) {
		return {name: a, latitude: b, longitude: c, defaultZoom: d};
	});
var _user$project$Devfriendly$townDecoder = A5(
	_elm_lang$core$Json_Decode$map4,
	_user$project$Devfriendly$Town,
	...
	A2(_elm_lang$core$Json_Decode$field, 'defaultZoom', _elm_lang$core$Json_Decode$int));
var _user$project$Devfriendly$Place = F3(
	function (a, b, c) {
		return {name: a, latitude: b, longitude: c};
	});
var _user$project$Devfriendly$placeDecoder = A4(
	_elm_lang$core$Json_Decode$map3,
	_user$project$Devfriendly$Place,
	A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'lat', _elm_lang$core$Json_Decode$float),
	A2(_elm_lang$core$Json_Decode$field, 'lon', _elm_lang$core$Json_Decode$float));
var _user$project$Devfriendly$placesDecode = function (jsonPlaces) {
	var result = A2(
		_elm_lang$core$Json_Decode$decodeString,
		_elm_lang$core$Json_Decode$list(_user$project$Devfriendly$placeDecoder),
		jsonPlaces);
	var _p0 = result;
	if (_p0.ctor === 'Ok') {
		return _p0._0;
...
var _user$project$Devfriendly$GetPlaces = function (a) {
	return {ctor: 'GetPlaces', _0: a};
};
var _user$project$Devfriendly$loadPlaces = function (url) {
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Devfriendly$GetPlaces,
		A2(
			_elm_lang$http$Http$get,
			url,
			_elm_lang$core$Json_Decode$list(_user$project$Devfriendly$placeDecoder)));
};
var _user$project$Devfriendly$update = F2(
	function (msg, model) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'TownSelected':
				var _p2 = _p1._0;
				var placesUrl = _user$project$Devfriendly$placesUrlFor(_p2.name);
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _elm_lang$core$Platform_Cmd$batch(
						{
							ctor: '::',
							_0: _user$project$Devfriendly$moveMap(_p2),
							_1: {
								ctor: '::',
								_0: _user$project$Devfriendly$loadPlaces(placesUrl),
								_1: {ctor: '[]'}
							}
						})
				};
			case 'GetTowns':
				if (_p1._0.ctor === 'Ok') {
					...
					var _p3 = A2(_elm_lang$core$Debug$log, 'Get Towns Failed', _p1._0._0);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
				...
				if (_p1._0.ctor === 'Ok') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								places: A2(_elm_lang$core$List$append, model.places, _p4)
							}),
						_1: _user$project$Devfriendly$addPlaces(_p4)
					};
				} else {
					var _p5 = A2(_elm_lang$core$Debug$log, 'Get Towns Failed', _p1._0._0);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
...
var _user$project$Devfriendly$GetTowns = function (a) {
	return {ctor: 'GetTowns', _0: a};
};
var _user$project$Devfriendly$loadTowns = function (url) {
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Devfriendly$GetTowns,
		A2(
			_elm_lang$http$Http$get,
			url,
			_elm_lang$core$Json_Decode$list(_user$project$Devfriendly$townDecoder)));
};
var _user$project$Devfriendly$TownSelected = function (a) {
	return {ctor: 'TownSelected', _0: a};
};
var _user$project$Devfriendly$viewTowns = function (towns) {
	var townsLi = A2(
		_elm_lang$core$List$map,
		function (town) {
			return A2(
				_elm_lang$html$Html$li,
				{
					...
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$Devfriendly$TownSelected(town)),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(town.name),
					_1: {ctor: '[]'}
				});
		},
		towns);
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('towns'),
			_1: {ctor: '[]'}
		},
		townsLi);
};
var _user$project$Devfriendly$view = function (model) {
	return _user$project$Devfriendly$viewTowns(model.towns);
};
var _user$project$Devfriendly$main = function () {
	var initialModel = {
		towns: {ctor: '[]'},
		places: {ctor: '[]'}
	};
	return _elm_lang$html$Html$program(
		{
			init: {
				...
				_1: _elm_lang$core$Platform_Cmd$batch(
					{
						ctor: '::',
						_0: _user$project$Devfriendly$loadTowns(_user$project$Devfriendly$townsUrl),
						_1: {
							ctor: '::',
							_0: _user$project$Devfriendly$loadPlaces(
								_user$project$Devfriendly$placesUrlFor('montpellier')),
							_1: {ctor: '[]'}
						}
					})
			},
			view: _user$project$Devfriendly$view,
			update: _user$project$Devfriendly$update,
...
var Elm = {};
Elm['Devfriendly'] = Elm['Devfriendly'] || {};
if (typeof _user$project$Devfriendly$main !== 'undefined') {
    _user$project$Devfriendly$main(Elm['Devfriendly'], 'Devfriendly', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Devfriendly.Msg":{"args":[],"tags":{"GetTowns":["Result.Result Http.Error (List Devfriendly.Town)"],"TownSelected":["Devfriendly.Town"],"GetPlaces":["Result.Result Http.Error (List Devfriendly.Place)"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Devfriendly.Place":{"args":[],"type":"{ name : String, latitude : Float, longitude : Float }"},"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Devfriendly.Town":{"args":[],"type":"{ name : String , latitude : Float , longitude : Float , defaultZoom : Int }"}},"message":"Devfriendly.Msg"},"versions":{"elm":"0.18.0"}});
}
